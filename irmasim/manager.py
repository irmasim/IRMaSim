            ...
            if new_state == 'LOCKED':
                ...
                for lcore in processor['local_cores']:
                    ...
                    if lcore.state['served_job'] is None:
                        ...
                        power = round(lcore.power("NEIGHBOURS-RUNNING",x,n, cores=len(processor['local_cores'])),9)
                ...
                for lcore in processor['local_cores']:
                    ...
                    if all_inactive:
                        x = processor['current_mem_bw']
                        n = served_jobs_processor
                        power = round(lcore.power("IDLE",x,n,cores=len(processor['local_cores'])),9)
    ...
    def overutilization_mem_bw_change_speed(self, now, processor, served_jobs_processor):
        ...
        for lcore in processor['local_cores']:
            ...
            if lcore.state['served_job'] is not None:
                ...
                power = round(lcore.power("RUN",x,n,cores=len(processor['local_cores'])),9)
