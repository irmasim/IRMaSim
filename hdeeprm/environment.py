...
Returns:
    Number of active resources.
        ...
        return len(
            [core for core in self.workload_manager.resource_manager.core_pool if core.state['served_job']]
        )
...
Returns:
    ...
    Negative the power usage in the data centre service.
        ...
        time = self.workload_manager.bs.time() - self.workload_manager.time_last_step
